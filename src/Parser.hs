...
happyExpList = Happy_Data_Array.listArray (0,31) ([128,1024,0,0,4,0,8192,0,2,32,1,4096,384,24576,0,0,0,0,192,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parse","Program","Function","Stmt","Expr","int","return","ident","intlit","'='","'+'","';'","'('","')'","'{'","'}'","%eof"]
...
happyReduction_2 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn5
		 (Function happy_var_2 happy_var_6
	) `HappyStk` happyRest
...
happyReduction_4 (HappyTerminal (TokenIntLit happy_var_1))
	 =  HappyAbsSyn7
		 (IntLit happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TokenIntLit happy_dollar_dollar -> cont 11;
	TokenAssign -> cont 12;
	TokenPlus -> cont 13;
	TokenSemi -> cont 14;
	TokenLParen -> cont 15;
